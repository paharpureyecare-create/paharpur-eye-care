...
export const EntryCenterView: React.FC = () => {
  ...
  return (
    <div className="space-y-6 pb-24">
      ...
      {/* 8. MASTER ACTION PANEL (NATURAL BOTTOM - NON-STICKY, SCROLLS WITH PAGE, NEVER COVERS INPUTS) */}
      <div className="mt-8 relative bg-slate-900 text-white p-5 rounded-2xl shadow-lg flex flex-wrap items-center justify-between gap-4 border border-slate-800">
        <div className="flex items-center gap-3">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <button
            onClick={clearClinicalDraft}
            className="px-4 py-2.5 bg-slate-800 hover:bg-slate-700 text-slate-300 rounded-xl text-xs font-bold flex items-center gap-1.5 transition-colors"
          >
          ...
          <button
            ...
            className="px-4 py-2.5 bg-amber-500 hover:bg-amber-400 text-slate-950 rounded-xl text-xs sm:text-sm font-extrabold flex items-center gap-1.5 shadow-sm transition-all hover:scale-105"
          >
          ...
          <button
            ...
            className="px-6 py-2.5 bg-teal-500 hover:bg-teal-400 text-slate-950 rounded-xl text-xs sm:text-sm font-black flex items-center gap-2 shadow-md transition-all hover:scale-105"
          >
